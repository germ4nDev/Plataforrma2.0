...
export class GestionModulopqComponent {
    ...
    modulosSeleccionados: PTLModuloAP[] = [];
            ...
            if (this.codigoPaquete) {
                ...
                this._registrosService.getRegistros().subscribe({
                    next: (resp: any) => {
                        ...
                        this.modulosSeleccionados = this.modulosPadre;
                        console.log('modulos paquete', modsPaquete);
                    },
                    error: () => {
    ...
    onSuiteChangeClick(value: any) {
        ...
        this.consultarMLodulos(suite.codigoSuite);
    }
    ...
    btnGestionarRegistroClick(codigo: string) {
        ...
        if (this.modulosSeleccionados.length > 0) {
            this.modulosSeleccionados.forEach(modulo => {
                ...
                registroData.estadoModulo = true;
                ...
                this._registrosService.postCrearRegistro(registroData).subscribe({
                    next: (resp: any) => {
                        console.log('reesp', resp.moduloPaquete);
                        if (resp.ok) {
                            const logData = {
                                codigoTipoLog: '',
                                codigoRespuesta: '201',
                            ...
                            this._swalAlertService.getAlertConfirmError(this.translate.instant('PLATAFORMA.INSERTAR'));
