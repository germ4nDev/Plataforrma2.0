        ...
        if (this.tipoRolSeleccionado === 'plataforma') {
          ...
          this.roles =
            !codigoAplicacion || codigoAplicacion === ''
              ...
              : this.roles
          this.todosLosRoles =
            !codigoSuite || codigoSuite === '' ? this.todosLosRoles.filter((r: any) => r.codigoSuite == codigoSuite) : this.todosLosRoles
        }
