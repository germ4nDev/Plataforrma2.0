...
//   rolesSeleccionados: PTLUsuarioRoleAPModel[] = [];
  ...
  constructor(
    ...
    //   this.codigoUsuario = params['usuId'];
    //   if (this.codigoUsuario) {
    //     this.FormRegistro.codigoUsuaio = this.codigoUsuario;
    //     this.consultarUsuarioById(this.codigoUsuario);
    //   }
    //   if (this.registroId) {
...
//   private async consultarUsuarioById(id: string) {
//     try {
//       const resp = await firstValueFrom(
...
//     const roleIx = this.rolesSeleccionados.findIndex((x) => x.codigoRole === role.codigoRole);
//     if (checked) {
//       const existe = this.rolesSeleccionados.some((r) => r.codigoRole === role.codigoRole);
//       if (!existe) {
//         this.rolesSeleccionados.push(role);
//       }
//     } else {
