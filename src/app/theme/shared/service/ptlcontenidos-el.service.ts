...
export class PTLContenidosELService {
    ...
    getContenido() {
        ...
        return this.http.get<PTLContenidoEL[]>( url, this.headers )
        .pipe(
            map((resp: PTLContenidoEL[]) => {
    ...
    insertarContenido(contenido: PTLContenidoEL) {
    ...
    modificarContenido(contenido: PTLContenidoEL) {
